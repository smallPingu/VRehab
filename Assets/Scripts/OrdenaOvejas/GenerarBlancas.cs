...
public class GenerarBlancas : MonoBehaviour
{
    public GameObject ovejaBlanca;
    ...
    void Start()
    {
        ...
        int numGener = GuardarPuntuacion.Instance.GetPuntBlancas();
        Debug.Log("Puntuacion blancas: " + numGener);
